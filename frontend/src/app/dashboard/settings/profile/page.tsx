        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white dark:bg-gray-800 border-none rounded-2xl px-4 py-4 text-[15px] font-medium text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 shadow-sm"
              required
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              value={email}
              readOnly
              className="w-full bg-white dark:bg-gray-800 border-none rounded-2xl px-4 py-4 text-[15px] font-medium text-gray-900 dark:text-white opacity-80 shadow-sm"
            />
          </div>
