  ...
  return (
    <div className="min-h-full flex flex-col bg-[#f4f5f8] dark:bg-[#181818] pb-20">
      ...
      <div className="flex-1 flex flex-col px-4 mt-2">
        ...
        {/* User Card */}
        <div className="bg-white dark:bg-[#454545] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-5 flex items-center gap-4 mb-4">
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          <div className="bg-white dark:bg-[#454545] rounded-2xl p-4 flex flex-col items-center justify-center shadow-sm border border-gray-100 dark:border-gray-700/50">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            ...
            }} className="flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
            ...
            <Link href="/dashboard/transactions" className="flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eaf1ff] dark:bg-blue-900/30 flex items-center justify-center text-[#2d68d8]">
            ...
            <Link href="/dashboard/settings/addresses" className="flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eaf1ff] dark:bg-blue-900/30 flex items-center justify-center text-[#2d68d8]">
            ...
            <Link href="/dashboard/settings/deposit-log" className="flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eaf1ff] dark:bg-blue-900/30 flex items-center justify-center text-[#2d68d8]">
                  <Download size={20} />
                </div>
            ...
            <Link href="/dashboard/cards" className="flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eaf1ff] dark:bg-blue-900/30 flex items-center justify-center text-[#2d68d8]">
                  <CreditCard size={20} />
                </div>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            ...
            <Link href="/dashboard/settings/profile" className="flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eaf1ff] dark:bg-blue-900/30 flex items-center justify-center text-[#2d68d8]">
                  <User size={20} />
                </div>
            ...
            <Link href="/dashboard/settings/security" className="flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eaf1ff] dark:bg-blue-900/30 flex items-center justify-center text-[#2d68d8]">
                  <Lock size={20} />
                </div>
            ...
            <button onClick={logout} className="w-full flex items-center justify-between bg-white dark:bg-[#454545] px-4 py-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#eaf1ff] dark:bg-blue-900/30 flex items-center justify-center text-[#2d68d8]">
                  <LogOut size={20} />
                </div>
