    ...
    <div className="flex flex-col min-h-full pb-20 bg-gray-50 dark:bg-[#181818]">
      ...
      {step === 1 && (
        <div className="flex-1 p-4 md:p-6 max-w-2xl mx-auto w-full">
          ...
          <div className="bg-white dark:bg-[#454545] rounded-[28px] p-2 shadow-sm border border-gray-100 dark:border-gray-700/50">
            {/* Tabs */}
            <div className="flex bg-gray-50 dark:bg-[#454545] rounded-2xl p-1 mb-4">
              <button 
                onClick={() => setActiveTab('borrow')}
                className={`flex-1 py-2.5 rounded-xl shadow-sm text-sm font-semibold transition-colors ${activeTab === 'borrow' ? 'bg-white dark:bg-[#454545] text-gray-900 dark:text-white' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'}`}
              >Borrow</button>
              <button 
                onClick={() => setActiveTab('earn')}
                className={`flex-1 py-2.5 rounded-xl shadow-sm text-sm font-semibold transition-colors ${activeTab === 'earn' ? 'bg-white dark:bg-[#454545] text-gray-900 dark:text-white' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'}`}
              >Earn</button>
            </div>
            ...
            {activeTab === 'borrow' ? (
              <>
                {/* Collateral Input */}
                <div className="bg-gray-50 dark:bg-[#454545] rounded-2xl p-4 mb-2">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 bg-white dark:bg-[#454545] px-3 py-2 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 shrink-0 hover:bg-gray-50 transition-colors"
                    >
                ...
                <div className="relative flex justify-center -my-3 z-10">
                  <div className="w-8 h-8 rounded-full bg-white dark:bg-[#454545] border border-gray-100 dark:border-gray-700 shadow-sm flex items-center justify-center text-gray-400">
                    <ArrowDown size={16} />
                  </div>
                </div>

                {/* Loan Output */}
                <div className="bg-gray-50 dark:bg-[#454545] rounded-2xl p-4 mt-2 mb-4">
                ...
                <div className="flex gap-2 mb-4">
                  <div 
                    ...
                    className="flex-1 bg-gray-50 dark:bg-[#454545] rounded-xl p-3 flex justify-between items-center cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                  >
              ...
              <>
                {/* Earn Input */}
                <div className="bg-gray-50 dark:bg-[#454545] rounded-2xl p-4 mb-4 mt-2">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input 
                    ...
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    className="rounded-xl bg-gray-50 dark:bg-[#454545]"
                  />
                  <div className="mt-2 text-sm text-blue-600 cursor-pointer font-medium">Verify with Phone</div>
                </div>

                <Button 
                  className="w-full py-4 text-[15px] font-medium rounded-2xl bg-white! dark:bg-[#454545]! text-gray-900! dark:text-white! border! border-gray-200! dark:border-gray-700! hover:bg-gray-50! dark:hover:bg-gray-700!"
      ...
      {(modalType === 'collateral' || modalType === 'loan' || modalType === 'earn') && (
        <div className="fixed inset-0 z-[100] flex flex-col bg-gray-100 dark:bg-[#181818] animate-in slide-in-from-bottom-full duration-300">
          <div className="flex items-center justify-between p-4 bg-white dark:bg-[#454545] border-b border-gray-200 dark:border-gray-700 sticky top-0">
          ...
          <div className="p-4 bg-white dark:bg-[#454545] border-b border-gray-200 dark:border-gray-700">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-gray-50 dark:bg-[#454545] text-gray-900 dark:text-white placeholder:text-gray-400 text-[15px] py-3 pl-10 pr-4 rounded-xl focus:outline-none border border-gray-100 dark:border-gray-700"
              />
            </div>
            <div className="text-sm font-medium text-gray-500 mt-4 px-1">Crypto assets</div>
          </div>

          <div className="flex-1 overflow-y-auto bg-white dark:bg-[#454545] pb-safe">
      ...
      {(modalType === 'ltv' || modalType === 'apr') && (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/40 animate-in fade-in duration-200" onClick={() => setModalType(null)}>
          <div 
            className="w-full sm:max-w-md bg-white dark:bg-[#454545] rounded-t-[32px] sm:rounded-2xl flex flex-col animate-in slide-in-from-bottom-full duration-300 pb-safe"
