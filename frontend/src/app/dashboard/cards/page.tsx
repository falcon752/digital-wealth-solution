    ...
    return (
      <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-[#181818] pb-20">
        ...
        <div className="p-4 flex-1 flex flex-col items-center mt-6">
          ...
          <div className="w-full max-w-sm mt-5 bg-white dark:bg-[#454545] rounded-2xl p-5 border border-gray-100 dark:border-gray-700 shadow-sm">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Card Information</h3>
            <div className="grid grid-cols-2 gap-3">
              {cardInfo.map((item) => (
                <div key={item.label} className="rounded-xl bg-gray-50 dark:bg-[#454545] px-4 py-3">
          ...
          <div className="w-full max-w-sm mt-8 bg-white dark:bg-[#454545] rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
          ...
          <div className="w-full max-w-sm mt-8 mb-4">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex items-center gap-4 bg-white dark:bg-[#454545] rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700/50">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-[#181818] pb-20">
      ...
      <form onSubmit={handleSubmit} className="p-4 flex-1 mt-2">
        <div className="bg-white dark:bg-[#454545] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-5 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-[#f4f5f8] dark:bg-[#454545] border-none rounded-xl px-4 py-3.5 text-sm font-medium text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
              required
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              value={cardNumber}
              readOnly
              className="w-full bg-[#f4f5f8] dark:bg-[#454545] border-none rounded-xl px-4 py-3.5 text-sm font-medium text-gray-500 dark:text-gray-400 font-mono"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full bg-[#f4f5f8] dark:bg-[#454545] border-none rounded-xl px-4 py-3.5 text-sm font-medium text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 appearance-none"
            >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-lg text-sm font-semibold text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition"
          >
