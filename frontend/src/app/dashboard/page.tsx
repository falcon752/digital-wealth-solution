  ...
  return (
    <div className="flex flex-col min-h-full pb-20 bg-[#f9f9fb] dark:bg-[#181818]">
      ...
      <div className="flex-1 p-5 space-y-6">
        ...
        {/* Header */}
        <div className="pt-2">
          <h1 className="text-[26px] font-semibold text-[#111827] dark:text-white mb-2 leading-tight">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Total LLCs */}
              <div className="bg-white dark:bg-[#454545] rounded-[16px] p-5 flex items-center justify-between shadow-[0_2px_15px_-4px_rgba(0,0,0,0.05)] border-l-4 border-l-[#1e3a8a]">
                <div>
              ...
              {/* Approved LLCs */}
              <div className="bg-white dark:bg-[#454545] rounded-[16px] p-5 flex items-center justify-between shadow-[0_2px_15px_-4px_rgba(0,0,0,0.05)] border-l-4 border-l-[#10b981]">
                <div>
              ...
              {/* Pending LLCs */}
              <div className="bg-white dark:bg-[#454545] rounded-[16px] p-5 flex items-center justify-between shadow-[0_2px_15px_-4px_rgba(0,0,0,0.05)] border-l-4 border-l-[#f59e0b]">
                <div>
            ...
            <div className="bg-white dark:bg-[#454545] rounded-[20px] shadow-[0_2px_15px_-4px_rgba(0,0,0,0.05)] p-5 pb-8 mt-6">
              ...
              <button
                ...
                className="w-full py-3.5 bg-[#1e3a8a] dark:bg-blue-600 text-white text-[15px] font-semibold rounded-[12px] shadow-sm hover:opacity-90 transition-opacity mb-6"
              >
                Form New LLC
              </button>
              ...
              {applications.length === 0 ? (
                ...
                <div className="w-full">
                  <div className="flex justify-between items-center text-[13px] font-semibold text-[#6b7280] dark:text-gray-400 px-1 mb-4 border-b border-gray-100 dark:border-gray-700 pb-2">
