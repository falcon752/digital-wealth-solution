...
function BuyModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 backdrop-blur-sm p-0 sm:p-4">
      <div className="bg-white dark:bg-[#454545] w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 max-h-[90vh] overflow-y-auto">
        {/* Modal header */}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-gray-50 dark:bg-[#454545] rounded-xl px-3 py-3 border border-gray-200 dark:border-gray-700">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#454545] text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
...
function ReceiveModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 backdrop-blur-sm p-0 sm:p-4">
      <div className="bg-white dark:bg-[#454545] w-full sm:max-w-sm rounded-t-3xl sm:rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100 dark:border-gray-800">
        ...
        <div className="px-6 py-6 text-center space-y-4">
          ...
          <div className="bg-gray-50 dark:bg-[#454545] rounded-xl px-4 py-3 border border-gray-200 dark:border-gray-700">
...
function AssetPickerModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 backdrop-blur-sm p-0 sm:p-4">
      <div className="bg-white dark:bg-[#454545] w-full sm:max-w-sm rounded-t-3xl sm:rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 max-h-[70vh] flex flex-col">
    ...
    <>
      ...
      {validationError && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/30 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-[#454545] rounded-2xl shadow-2xl p-8 max-w-xs w-full text-center">
            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="px-5 py-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center bg-gray-50 dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                    <input
                      {...register('amount')}
                      type="number"
                      step="any"
                ...
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl">
                    <input
            ...
            <>
              ...
              <div className="px-5 py-8 space-y-6 text-center">
                ...
                <input
                  ...
                  placeholder="000000"
                  className="w-full text-center text-2xl font-semibold tracking-widest px-4 py-4 rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-[#454545] text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 transition-colors"
                />
        ...
        {([
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center gap-2 py-4 rounded-2xl text-sm font-medium transition-all ${activeAction === key
                ...
                : 'bg-gray-100 dark:bg-[#454545] text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'
              }`}
          >
            <Icon size={20} />
