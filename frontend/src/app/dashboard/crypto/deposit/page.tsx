  ...
  return (
    <div className="flex flex-col min-h-full bg-white dark:bg-[#181818]">
      ...
      <div className="flex-1 px-4 py-6 space-y-4">
        {/* Card */}
        <div className="bg-white dark:bg-[#454545] rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
          ...
          <div className="px-4 pb-3" ref={dropRef}>
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3.5 bg-gray-100 dark:bg-[#454545] rounded-xl text-sm font-medium text-gray-900 dark:text-white"
            >
            ...
            {dropOpen && (
              <div className="mt-1 bg-white dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg overflow-hidden z-20 relative">
                {assets.map((a) => (
                  <button
                    key={a.id}
                    type="button"
          ...
          <div className="px-4 pb-5">
            <div className="bg-gray-100 dark:bg-[#454545] rounded-xl px-4 py-3">
