  ...
  return (
    <div className="flex flex-col min-h-full bg-white dark:bg-[#181818]">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-5">
        ...
        {/* Wallet address + copy */}
        <div className="flex items-center gap-2 bg-gray-50 dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3">
        ...
        <div>
          ...
          <div className="flex items-center bg-gray-50 dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3.5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-50 dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2d5be3]/40"
          />
        </div>
        ...
        <div>
          <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Transaction ID</p>
          <div
            className="w-full bg-gray-50 dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3.5 cursor-pointer"
