...
export default function CoinDetailPage() {
  ...
  return (
    <div className="flex flex-col min-h-full bg-white dark:bg-[#181818]">
      ...
      {/* ── Bottom navigation ──────────────────────────────────────────────── */}
      <div className="border-t border-gray-100 dark:border-gray-800 grid grid-cols-5 shrink-0 bg-white dark:bg-[#454545]">
        {([
      ...
      {bottomAction === 'send' && asset && (
        <div className="fixed inset-0 z-50 bg-white dark:bg-[#454545] flex flex-col overflow-y-auto">
          {/* Header */}
          ...
          {sendDone ? (
            ...
            <div className="px-5 py-6 space-y-7 max-w-lg mx-auto w-full">
              ...
              <div>
                ...
                {/* Wallet address */}
                <div className="flex items-center gap-3 bg-gray-50 dark:bg-[#454545] border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3">
