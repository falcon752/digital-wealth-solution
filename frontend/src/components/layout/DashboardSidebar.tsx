    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'fixed inset-y-0 left-0 z-50 flex flex-col h-[100dvh] w-[80%] max-w-[320px] bg-white dark:bg-[#101010] border-r border-gray-200 dark:border-gray-800 transition-transform duration-300 ease-in-out',
