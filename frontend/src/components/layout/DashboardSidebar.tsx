    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'fixed inset-y-0 left-0 z-50 flex flex-col h-[100dvh] w-[80%] max-w-[320px] bg-white dark:bg-[#2c2c2c] border-r border-gray-200 dark:border-gray-800 transition-transform duration-300 ease-in-out',
              ...
              <Link
                ...
                className={cn(
                  ...
                  active
                    ...
                    : 'bg-white border border-transparent dark:bg-[#2c2c2c] text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100'
                )}
              >
