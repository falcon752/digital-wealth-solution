...
const depositSchema = new mongoose.Schema(
  {
    ...
    sourceType: { type: String, enum: ['wallet', 'provider', 'exchange'], default: 'wallet' },
    provider: { type: String, default: null, trim: true },
    paymentMethod: { type: String, default: null, trim: true },
    destinationWalletAddress: { type: String, default: null, trim: true },
...
const llcApplicationSchema = new mongoose.Schema(
  {
    ...
    businessEnding: { type: String, default: null, trim: true },
    contactFirstName: { type: String, default: null, trim: true },
    contactLastName: { type: String, default: null, trim: true },
    contactUsername: { type: String, default: null, trim: true },
